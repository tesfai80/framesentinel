    ...
    <div>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <h1 style={{
            ...
            Stop Video KYC Fraud<br />Before It Happens
          </h1>
          <p style={{
            fontSize: '24px',
            color: '#9ca3af',
            ...
            Enterprise-grade AI fraud detection for video verification.<br />
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: '48px', fontWeight: 'bold', color: '#10b981', marginBottom: '8px' }}>99.7%</div>
            <div style={{ color: '#9ca3af', fontSize: '16px' }}>Detection Accuracy</div>
          </div>
          <div>
            <div style={{ fontSize: '48px', fontWeight: 'bold', color: '#10b981', marginBottom: '8px' }}>&lt;2s</div>
            <div style={{ color: '#9ca3af', fontSize: '16px' }}>Average Processing</div>
          </div>
          <div>
            <div style={{ fontSize: '48px', fontWeight: 'bold', color: '#10b981', marginBottom: '8px' }}>10M+</div>
            <div style={{ color: '#9ca3af', fontSize: '16px' }}>Videos Analyzed</div>
          </div>
          <div>
            <div style={{ fontSize: '48px', fontWeight: 'bold', color: '#10b981', marginBottom: '8px' }}>500+</div>
            <div style={{ color: '#9ca3af', fontSize: '16px' }}>Enterprise Clients</div>
          </div>
        </div>
      </section>
      ...
      <footer style={{
        ...
        <div style={{
          ...
          © 2024 FrameSentinel. All rights reserved.
        </div>
      </footer>
    </div>
  );
